...
const rows = [
  ...
  { id: 'delete', numeric: true, disablePadding: false, label: 'Xóa' }
];

class RegisterModuleTableHead extends React.Component {
...
RegisterModuleTableHead.propTypes = {
  onRequestSort: PropTypes.func.isRequired,
  order: PropTypes.string.isRequired,
  orderBy: PropTypes.string.isRequired
};

export default RegisterModuleTableHead;
