...
class LookUpModule extends React.Component {
  state = {
    modules: [],
    filters: {
      moduleId: '',
  ...
  render() {
    ...
    return (
      <Section header="HỌC PHẦN" subheader="TÌM KIẾM HỌC PHẦN">
        ...
        {isLoading ? <Loading /> : <LookUpTable data={modules} filters={filters} />}
      </Section>
    );
  }
}

LookUpModule.propTypes = {
  classes: PropTypes.shape({}).isRequired
};

export default withStyles(styles)(LookUpModule);
